...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        Integer max = Collections.max(repeats.values()); // нашли максимальное количество повторов
        ...
        for (Map.Entry <Integer, Integer> repeat : repeats.entrySet()) {
            if (repeat.getValue().equals(max)) { // и если имеются значения, равные максимальному, выводи на экран
